...
//        public DieuTrisController(ApplicationDbContext context)
//        {
//            _context = context;
//        }
...
//            var thanhTienLSNX = _context.ThiTruongs.SingleOrDefault(k => k.TenSanPham == khoId.IdsanPhamNavigation.TenSanPham).DonGia;
//            var DonGia = _context.DichVus.SingleOrDefault(m => m.IddichVu == dt.IddichVu).DonGia;
//            var DonviTinh = _context.ThiTruongs.FirstOrDefault(k => k.TenSanPham == khoId.IdsanPhamNavigation.TenSanPham);
//            if (khoExists)
//            {
//                if (dt.SoLuong <= 0)
//                {
